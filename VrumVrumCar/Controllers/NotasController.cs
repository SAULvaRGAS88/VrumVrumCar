...
namespace VrumVrumCar.Controllers
{
    public class NotasController : Controller
    {
        private readonly VrumVrumCarContext _context;

        public NotasController(VrumVrumCarContext context)
        {
            _context = context;
        }
        ...
        {
            var vrumVrumCarContext = _context.Nota.Include(n => n.Carro).Include(n => n.Cliente).Include(n => n.Vendedor);
            return View(await vrumVrumCarContext.ToListAsync());
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VrumVrumCarContext.Nota'  is null.");
            }
            var nota = await _context.Nota.FindAsync(id);
            if (nota != null)
            {
