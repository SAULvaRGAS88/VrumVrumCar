...
namespace VrumVrumCar.Controllers
{
    public class CarroesController : Controller
    {
        ...
        public CarroesController(VrumVrumCarContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Carro != null ? 
                          ...
                          Problem("Entity set 'VrumVrumCarContext.Carro'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VrumVrumCarContext.Carro'  is null.");
            }
            var carro = await _context.Carro.FindAsync(id);
            if (carro != null)
            {
