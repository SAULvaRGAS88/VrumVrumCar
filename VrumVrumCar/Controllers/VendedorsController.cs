...
namespace VrumVrumCar.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(VrumVrumCarContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vendedor != null ? 
                          ...
                          Problem("Entity set 'VrumVrumCarContext.Vendedor'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'VrumVrumCarContext.Vendedor'  is null.");
            }
            var vendedor = await _context.Vendedor.FindAsync(id);
            if (vendedor != null)
            {
